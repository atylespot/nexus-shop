...
export default function SiteSettingsPage() {
  ...
  useEffect(() => {
    ...
    if (savedBannerSettings) {
      ...
      // Ensure flashSaleBanner exists with default values
  ...
  const saveHeaderSettings = () => {
    ...
    // Verify save
    const saved = localStorage.getItem('nexus-shop-header-settings');
    console.log('✅ Header settings saved to localStorage:', saved ? 'SUCCESS' : 'FAILED');
  ...
  const saveBannerSettings = () => {
    ...
    // Verify save
    const saved = localStorage.getItem('nexus-shop-banner-settings');
    console.log('✅ Banner settings saved to localStorage:', saved ? 'SUCCESS' : 'FAILED');
  ...
  const saveFooterSettings = () => {
    ...
    // Verify save
    const saved = localStorage.getItem('nexus-shop-footer-settings');
    console.log('✅ Footer settings saved to localStorage:', saved ? 'SUCCESS' : 'FAILED');
