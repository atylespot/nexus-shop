            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="mailto:info@nexusshop.com" className="text-blue-600 hover:text-blue-700">
                      info@nexusshop.com
                    </a>
                  </p>
                  <p className="text-gray-600">
                    <a href="mailto:support@nexusshop.com" className="text-blue-600 hover:text-blue-700">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="tel:+880123456789" className="text-blue-600 hover:text-blue-700">
                      +880 123 456 789
                    </a>
                  </p>
                  <p className="text-gray-600">
                    <a href="tel:+880987654321" className="text-blue-600 hover:text-blue-700">
                      +880 987 654 321
                    </a>
                  </p>
                </div>
