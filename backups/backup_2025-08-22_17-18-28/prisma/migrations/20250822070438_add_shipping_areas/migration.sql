...
INSERT INTO "new_LandingPage" ("blocks", "createdAt", "customerReviews", "discountPrice", "headerImage", "id", "pixelIds", "productDescription", "productFeatures", "productId", "productImages", "publishedAt", "regularPrice", "slug", "status", "subtitle", "title", "updatedAt", "videoUrl") SELECT "blocks", "createdAt", "customerReviews", "discountPrice", "headerImage", "id", "pixelIds", "productDescription", "productFeatures", "productId", "productImages", "publishedAt", "regularPrice", "slug", "status", "subtitle", "title", "updatedAt", "videoUrl" FROM "LandingPage";
