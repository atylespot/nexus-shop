...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      if (ctaText || variantConfig || paymentMethod) landingData.blocks = { ctaText, variantConfig, paymentMethod };
...
export async function PUT(req: NextRequest) {
  try {
    ...
    console.error('PUT landing page view count error:', e);
